...
public class TestDistrubutedCacheDriver
{
	...
	public void setUp()
	{
		...
		DistrubutedCacheMapper mapper=new DistrubutedCacheMapper();		
		DistrubutedCacheReducer reducer= new DistrubutedCacheReducer();
