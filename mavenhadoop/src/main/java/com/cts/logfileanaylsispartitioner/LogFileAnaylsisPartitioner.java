...
public class LogFileAnaylsisPartitioner<K2, V2> extends Partitioner<Text, Text> implements
    Configurable {
  ...
  public int getPartition(Text key, Text value, int numReduceTasks) {
	  if((months.get(value.toString()))==null || (int)(months.get(value.toString()))==0)
	  {
		  return 0;
	  }
	  else
